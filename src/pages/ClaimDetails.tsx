...
const ClaimDetails: React.FC = () => {
  ...
  if (!claim) {
    return (
      <div className="flex flex-col items-center justify-center h-full">
        ...
        <button 
          onClick={() => navigate('/')}
          className="bg-corporate-secondary text-white px-4 py-2 rounded-md hover:bg-corporate-accent transition-colors"
        >
          Back to Dashboard
        </button>
      </div>
  ...
  const handleInstallerNameChange = (name: string) => {
    if (claim) {
      updateClaim(claim.id, {
        installerName: name
      });
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div className="flex space-x-2">
          ...
          <button 
            className={`${isEditing ? 'bg-green-600 hover:bg-green-700' : 'bg-corporate-secondary hover:bg-corporate-accent'} text-white px-3 py-2 rounded transition-colors flex items-center`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    <textarea 
                      className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-corporate-secondary focus:border-transparent"
                      rows={5}
        ...
        {activeTab === 'products' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              {isEditing && (
                <button className="bg-corporate-secondary text-white px-3 py-1 rounded-md text-sm">
                  + Add Product
                </button>
              )}
            </div>
                    ...
                    <tr key={product.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {isEditing ? (
                          <input 
                            type="text" 
                            className="w-full p-1 border border-gray-300 rounded focus:ring-corporate-secondary focus:border-corporate-secondary" 
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {isEditing ? (
                          <input 
                            type="number" 
                            className="w-20 p-1 border border-gray-300 rounded focus:ring-corporate-secondary focus:border-corporate-secondary" 
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {isEditing && (
                  <div className="flex items-center justify-center h-36 border-2 border-dashed border-gray-300 rounded-lg hover:border-corporate-secondary transition-colors">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg">
                <ul className="divide-y divide-gray-200">
                  {claim.documents.filter(doc => doc.type !== 'image').map((doc) => (
                    <li key={doc.id} className="p-4 hover:bg-gray-100 transition-colors">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div className="p-2 bg-corporate-light text-corporate-dark rounded">
                  ...
                  {isEditing && (
                    <li className="p-4">
                      <div className="flex items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-corporate-secondary transition-colors">
  ...
  return (
    <button
      className={`flex items-center px-4 py-3 text-sm font-medium border-b-2 transition-colors ${
        active 
          ? 'border-corporate-secondary text-corporate-secondary' 
