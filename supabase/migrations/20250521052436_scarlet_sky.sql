/*
  ...
  1. Security
    ...
    - Creates policies for claims, claim products, claim documents, and products
    - Sets up user management fields for claims

  2. Changes
    - Adds created_by and assigned_to columns to claims table
    - Creates policies for managing claims and related data
    - Sets up automatic created_by assignment for new claims

  3. Notes
    - All operations are idempotent using DO blocks for policy creation
    - Policies ensure users can only manage their own claims or ones assigned to them
    - Products table has read-only access for all authenticated users
*/
