/*
  # Add Alert System to Claims

  1. New Fields
    - `alerts` - JSONB array to store multiple alerts per claim
    - `alert_count` - Integer for quick filtering/sorting
    - `last_alert_check` - Timestamp to track when alerts were last evaluated

  2. Functions
    - Add function to automatically update alert_count when alerts change
    - Add function to evaluate alerts based on business rules
*/
